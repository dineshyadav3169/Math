...
export default function Terms() {
  return (
    <HomeContainer>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Interpretation and Definitions</h1>
      <h2 className="font-bold text-xl md:text-2xl tracking-tight mb-4 mt-8 text-black">Interpretation</h2>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Acknowledgment</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Links to Other Websites</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Termination</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Limitation of Liability</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Governing Law</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Disputes Resolution</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >United States Legal Compliance</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Severability and Waiver</h1>
      <h2 className="font-bold text-xl md:text-2xl tracking-tight mb-4 mt-8 text-black">Severability</h2>
      <p>
      ...
      <h2 className="font-bold text-xl md:text-2xl tracking-tight mb-4 mt-8 text-black">Waiver</h2>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Translation Interpretation</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Changes to These Terms and Conditions</h1>
      <p>
      ...
      <h1 className="font-bold text-2xl md:text-4xl tracking-tight mb-4 mt-8 text-black " >Contact Us</h1>
      <p>
